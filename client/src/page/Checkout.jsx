...
//                             <p>{deliveryAddress.address_line_1}, {deliveryAddress.address_line_2}</p>
//                             <p className="text-gray-600">City: {deliveryAddress.city}</p>
//                             <p className="text-gray-600">State: {deliveryAddress.state}</p>
//                             <p className="text-gray-600">Zip: {deliveryAddress.zip}</p>
//                             <p className="text-gray-600">Mobile: {deliveryAddress.mobile}</p>
//                         </div>
//                         <button onClick={() => setStep(0)} className="text-blue-500 mt-2">Change Address</button>
//                     </div>
//                 ) : (
//                     <Address data={addresses} dispatch={handleDeliveryAddress} />
//                 )}
//             </div>
